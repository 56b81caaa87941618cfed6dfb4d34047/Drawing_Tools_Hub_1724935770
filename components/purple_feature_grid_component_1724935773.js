        ...
        <div id="feature-1">
            <div id="feature-1-header" class="flex items-center space-x-2 mb-1">
               ...
               <div class="flex" id="feature-1-title-container">
                    <h4 id="feature-1-title" class="flex-1 text-slate-50 font-medium">Premium Quality Pencils</h4>
                </div>
            </div>
            <div class="flex" id="feature-1-description-container">
                <p id="feature-1-description" class="flex-1 text-sm">Experience the smoothest strokes with our carefully selected range of professional-grade pencils, perfect for sketching and shading.</p>
            </div>
        </div>
        ...
        <div id="feature-2">
            <div id="feature-2-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-2-title-container">
                    <h4 id="feature-2-title" class="flex-1 text-slate-50 font-medium">Versatile Sketchbooks</h4>
                </div>
            </div>
            <div class="flex" id="feature-2-description-container">
                <p id="feature-2-description" class="flex-1 text-sm">Unleash your creativity on our high-quality sketchbooks, designed to handle various mediums and techniques without bleeding or warping.</p>
            </div>
        </div>
        ...
        <div id="feature-3">
            <div id="feature-3-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-3-title-container">
                    <h4 id="feature-3-title" class="flex-1 text-slate-50 font-medium">Precision Erasers</h4>
                </div>
            </div>
            <div class="flex" id="feature-3-description-container">
                <p id="feature-3-description" class="flex-1 text-sm">Refine your artwork with our selection of erasers, from kneaded to gum, providing clean and precise corrections without damaging your paper.</p>
            </div>
        </div>
        ...
        <div id="feature-4">
            <div id="feature-4-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-4-title-container">
                    <h4 id="feature-4-title" class="flex-1 text-slate-50 font-medium">Artist-Grade Colored Pencils</h4>
                </div>
            </div>
            <div class="flex" id="feature-4-description-container">
                <p id="feature-4-description" class="flex-1 text-sm">Bring vibrant life to your drawings with our extensive palette of colored pencils, offering rich pigmentation and excellent blendability.</p>
            </div>
        </div>
        ...
        <div id="feature-5">
            <div id="feature-5-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-5-title-container">
                    <h4 id="feature-5-title" class="flex-1 text-slate-50 font-medium">Innovative Digital Tools</h4>
                </div>
            </div>
            <div class="flex" id="feature-5-description-container">
                <p id="feature-5-description" class="flex-1 text-sm">Explore the world of digital art with our curated selection of drawing tablets, styluses, and software, bridging traditional and modern techniques.</p>
            </div>
        </div>
        ...
        <div id="feature-6">
            <div id="feature-6-header" class="flex items-center space-x-2 mb-1">
                ...
                <div class="flex" id="feature-6-title-container">
                    <h4 id="feature-6-title" class="flex-1 text-slate-50 font-medium">Comprehensive Learning Resources</h4>
                </div>
            </div>
            <div class="flex" id="feature-6-description-container">
                <p id="feature-6-description" class="flex-1 text-sm">Enhance your skills with our library of tutorials, workshops, and guides, tailored for artists of all levels to master various drawing techniques and styles.</p>
            </div>
        </div>
    </div>
</template>
